...
const Footer = () => {
  ...
  return (
    <div className="bg-[#05095D] flex md:flex-row flex-col items-center justify-between px-[3rem] h-[20vh] py-[1rem]">
      <div>
        <h4 className="text-white">smarty</h4>
      </div>
      <div>
      ...
      <div>
        <ul className="flex items-center justify-evenly gap-x-[1rem]">
          <li>
            <svg
              width="25"
              height="25"
